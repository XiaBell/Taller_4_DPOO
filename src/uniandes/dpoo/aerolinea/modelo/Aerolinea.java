...
public class Aerolinea
{
    ...
    public int venderTiquetes( String identificadorCliente, String fecha, String codigoRuta, int cantidad ) throws VueloSobrevendidoException, Exception
    {
        ...
        if (vuelo == null) {
            throw new Exception("No existe un vuelo con la ruta " + codigoRuta + " en la fecha " + fecha);
        }
        ...
        int tarifaTotal = vuelo.venderTiquetes(cliente, cantidad);
        cliente.agregarTiquete(null);
     ...
     */
    public int consultarSaldoPendienteCliente(String identificadorCliente) {
        Cliente cliente = getCliente(identificadorCliente);

        return cliente.calcularValorTotalTiquetes();
    }
